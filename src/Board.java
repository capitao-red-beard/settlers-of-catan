...
public class Board {
    ...
    public Board() {
        ...
        tiles[0] = new Tile(new Terrain("Harbour"), 3);
        tiles[1] = new Tile(new Terrain("Sea"));
        tiles[2] = new Tile(new Terrain("Wool"), 2);
        tiles[3] = new Tile(new Terrain("Sea"));
        tiles[4] = new Tile(new Terrain("Sea"));
        tiles[5] = new Tile(new Terrain("Forest"), 11);
        tiles[6] = new Tile(new Terrain("Pasture"), 12);
        tiles[7] = new Tile(new Terrain("Field"), 9);
        tiles[8] = new Tile(new Terrain("Harbour"), 3);
        tiles[9] = new Tile(new Terrain("Harbour"), 2);
        tiles[10] = new Tile(new Terrain("Hill"), 4);
        tiles[11] = new Tile(new Terrain("Mountain"), 6);
        tiles[12] = new Tile(new Terrain("Hill"), 5);
        tiles[13] = new Tile(new Terrain("Pasture"), 10);
        tiles[14] = new Tile(new Terrain("Sea"));
        tiles[15] = new Tile(new Terrain("Sea"));
        tiles[16] = new Tile(new Terrain("Desert"));
        tiles[17] = new Tile(new Terrain("Forest"), 3);
        tiles[18] = new Tile(new Terrain("Field"), 11);
        tiles[19] = new Tile(new Terrain("Forest"), 4);
        tiles[20] = new Tile(new Terrain("Field"), 8);
        tiles[21] = new Tile(new Terrain("Harbour"), 3);
        tiles[22] = new Tile(new Terrain("Harbour"), 2);
        tiles[23] = new Tile(new Terrain("Hill"), 8);
        tiles[24] = new Tile(new Terrain("Pasture"), 10);
        tiles[25] = new Tile(new Terrain("Pasture"), 9);
        tiles[26] = new Tile(new Terrain("Mountain"), 3);
        tiles[27] = new Tile(new Terrain("Sea"));
        tiles[28] = new Tile(new Terrain("Mountain"), 5);
        tiles[29] = new Tile(new Terrain("Field"), 2);
        tiles[30] = new Tile(new Terrain("Forest"), 6);
        tiles[31] = new Tile(new Terrain("Harbour"), 2);
        tiles[32] = new Tile(new Terrain("Harbour"), 3);
        tiles[33] = new Tile(new Terrain("Sea"));
        tiles[34] = new Tile(new Terrain("Sea"));
        tiles[35] = new Tile(new Terrain("Harbour"), 2);
        tiles[36] = new Tile(new Terrain("Sea"));
