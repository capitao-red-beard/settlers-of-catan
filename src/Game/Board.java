...
public class Board {
    ...
    public Board() {
        ...
        tiles[0] = new Tile(new Harbor(null, 3));
        tiles[1] = new Tile(new Sea());
        tiles[2] = new Tile(new Harbor(new Wool(), 2));
        ...
        tiles[8] = new Tile(new Harbor(null, 3));
        tiles[9] = new Tile(new Harbor(new Ore(), 2));
        ...
        tiles[21] = new Tile(new Harbor(null, 3));
        tiles[22] = new Tile(new Harbor(new Grain(), 2));
        ...
        tiles[31] = new Tile(new Harbor(new Brick(), 2));
        tiles[32] = new Tile(new Harbor(null, 3));
        tiles[33] = new Tile(new Sea());
        tiles[34] = new Tile(new Sea());
        tiles[35] = new Tile(new Harbor(new Lumber(), 2));
